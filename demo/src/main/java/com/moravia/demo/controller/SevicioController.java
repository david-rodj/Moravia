    ...
    public class SevicioController {
        ...
        public String detalleServicio(Model model, @PathVariable String idServicio) {
        ...
        public String editarServicioForm(@PathVariable String idServicio, Model model) {
